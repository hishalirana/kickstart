 ...
 * @author user
 */
public class techinv extends javax.swing.JFrame {

    /**
     * Creates new form techinv
     */
    public techinv() {
        initComponents();
         try{
        ...
        String sql="select *,linkdin,email from untitled2,untitled where category='Technology' and name=nfounder ";
    ...
    private void initComponents() {
        ...
        jLabel1.setText("STARTUPS IN TECHNOLOGY");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(techinv.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
