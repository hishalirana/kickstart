 ...
 * @author user
 */
public class fiainv extends javax.swing.JFrame {

    /**
     * Creates new form fiainv
     */
    public fiainv() {
        initComponents();
         try{
        ...
        String sql="select *,linkdin,email from untitled2,untitled where category='Finance' and name=nfounder";
    ...
    private void initComponents() {
        ...
        jLabel1.setText("STARTUPS IN FINANCE");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(fiainv.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
